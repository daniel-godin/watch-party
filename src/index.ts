// Imports:
import { createWatchPartyNewWatchPartyUI } from "./watch-party";
...
export async function createIndexPageUI(mainContentContainer: HTMLElement, user: object) {
    ...
    mainContentContainer.insertAdjacentHTML('afterbegin', `
        <main id='mainIndexPageContainer'>
            <section id='indexPageGreetingContainer'>
            ...
            <section id='indexPageCreateWatchPartyContainer'>
            </section>
        </main>
    `)

    const indexPageCreateWatchPartyContainer = document.getElementById('indexPageCreateWatchPartyContainer') as HTMLElement;
    createWatchPartyNewWatchPartyUI(indexPageCreateWatchPartyContainer);
}